...
/**
 * @fileOverview AI-powered summarization tool for notes.
 *
 * - summarizeNotes - A function that summarizes notes content using AI.
...
const SummarizeNotesInputSchema = z.object({
  notesContent: z
    .string()
    .describe('The content of the notes to be summarized.'),
});
